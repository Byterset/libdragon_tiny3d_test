...
/// @brief GJK Support function (see gjk_support_function) for the capsule primitive.
///
/// Will return the point on the capsule boundary furthest in the input direction.
/// @param data pointer to the physics_object holding the capsule collider
...
/// @brief Bounding Box Calculator function for the capsule primitive.
///
/// Calculates the AABB fully containing the (optionally rotated) capsule.
/// @param data pointer to the physics_object holding the capsule collider
...
/// @brief Inertia Tensor function for the capsule primitive.
///
