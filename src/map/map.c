...
//     t3d_model_draw_custom(map->model, (T3DModelDrawConf){
...
void map_init(struct map* map) {
    ...
    rspq_block_begin();
        t3d_model_draw(map->renderable.model);
    map->renderable.block = rspq_block_end();
    ...
    // map->model = t3d_model_load("rom:/models/map/map.t3dm");
